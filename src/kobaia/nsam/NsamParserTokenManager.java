/* Generated By:JavaCC: Do not edit this line. NsamParserTokenManager.java */
package kobaia.nsam;
import java.net.*;
import java.io.*;
import java.util.*;
...
/** Token Manager. */
public class NsamParserTokenManager implements NsamParserConstants
{
...
private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 64:
         jjmatchedKind = 30;
         return jjMoveStringLiteralDfa1_0(0x26800000L);
      case 91:
   ...
   switch(curChar)
   {
      ...
      case 115:
         if ((active0 & 0x8000000L) != 0L)
            return jjStartNfaWithStates_0(1, 27, 53);
         break;
      default :
         break;
   }
...
private int jjMoveStringLiteralDfa2_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 115:
         if ((active0 & 0x1000000L) != 0L)
            return jjStartNfaWithStates_0(2, 24, 53);
...
static final int[] jjnextStates = {
   19, 20, 21, 49, 50, 51, 52, 33, 34, 35, 36, 25, 28, 1, 2, 4, 
   26, 27, 39, 40, 45, 46, 11, 12, 13, 14, 15, 33, 34, 35, 36, 38, 
   40, 43, 49, 50, 51, 52, 
};
...
"", null, null, null, null, null, null, "\53", "\55", "\57", "\52", "\50", 
"\51", "\133", "\135", "\173", "\175", "\72", "\73", "\54", "\74", "\76", "\56", 
"\100\160\162\145\146\151\170", "\150\141\163", "\100\150\141\163", "\100\151\163", "\151\163", "\157\146", 
"\100\157\146", "\100", "\74\76", null, null, null, null, null, null, null, null, null, null, 
null, null, null, null, "\75\76", "\75", };
...
/** Constructor. */
public NsamParserTokenManager(JavaCharStream stream){
...
/** Constructor. */
public NsamParserTokenManager(JavaCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
